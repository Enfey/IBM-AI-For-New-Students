...
/**
 * Custom hook for managing chat messages and operations Note: will provide better comments on request if anyone doesn't understand interaction between the hooks.
 *
